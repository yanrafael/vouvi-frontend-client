...
function ChooseIncomeCategory() {
  const categories = [
    { id: 0, title: "Salário" },
    { id: 1, title: "Freelance" },
    { id: 2, title: "Investimentos" },
  ];
      ...
      <div className="h-fit w-fit min-w-80 rounded-md bg-white p-9 text-md text-black shadow-lg shadow-black/50">
        ...
        <div className="flex justify-between">
          ...
          <button className="cursor-pointer">
            <Icon
              onClick={() => hideModal("choose-income-category")}
...
export default ChooseIncomeCategory;
