...
function Top() {
    ...
    return (
        <section className='flex w-[90%] m-auto mt-14 border-b-2 border-[#252525] dark:border-[#F5F5F442] pb-16'>
            ...
            <hr className='relative bg-[#252525] dark:bg-[#F5F5F442] h-96 w-[2px] right-24' />
