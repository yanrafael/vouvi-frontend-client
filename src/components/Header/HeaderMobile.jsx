...
function HeaderMobile({ iconId }) {
    ...
    const Learn = (
        ...
        >
            <rect
                className={` group-hover:fill-[#003F7F] ${iconId === 0 ? bgFill : ""
                    }`}
                width="46"
                height="46"
                rx="23"
            ...
            />
            <path
                className={` group-hover:fill-[#007fff] ${iconId === 0 ? iconColor : ""
                    }`}
    ...
    const Planning = (
        ...
        >
            <rect
                className={` group-hover:fill-[#003F7F] ${iconId === 1 ? bgFill : ""
                    }`}
                width="46"
                height="46"
                rx="23"
            ...
            />
            <path
                className={` group-hover:fill-[#007fff] ${activeIcon === 1 ? iconColor : ""
                    } `}
    ...
    const Ranking = (
        ...
        >
            <rect
                className={` group-hover:fill-[#003F7F] ${iconId === 2 ? bgFill : ""
                    }`}
                width="46"
                height="46"
                rx="23"
            ...
            />
            <path
                className={` group-hover:fill-[#007fff] ${iconId === 2 ? iconColor : ""
                    }`}
    ...
    const Store = (
        ...
        >
            <rect
                className={` group-hover:fill-[#003F7F] ${iconId === 3 ? bgFill : ""
                    }`}
                width="46"
                height="46"
                rx="23"
            ...
            />
            <path
                className={` group-hover:fill-[#007fff] ${iconId === 3 ? iconColor : ""
                    }`}
    ...
    return (
        <header className="h-24 z-10 m-auto flex w-full items-center justify-around bg-[rgba(2,2,11,0.15)] lg:py-7 xl:py-8 2xl:py-10 backdrop-blur-[13px] dark:bg-[rgba(2,2,11,0.80);]">
            <nav className="flex">
                <Link to={"/learn"}>
