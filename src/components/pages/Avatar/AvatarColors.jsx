...
function AvatarColors({ Eyes, Necklace, Pendant, Texture, Background}) {
    ...
    const Color = ['#007FFF', '#FF2D2D', '#37FF2D', '#7C20BE', '#FF8800', '#FF0084'];
    ...
    }} className={` w-10/12 flex pt-16 rounded-md border-[10px] border-white dark:border-black transition-all duration-500`}>
                {AvatarStyle}
                <div className="absolute ml-[137px] mt-20"><img width='140px' src={Eyes} alt="" /></div>
                <div className="absolute ml-[137px] mt-[12rem]"><img width='140px' src={Necklace} alt="" /></div>
                <div className="absolute ml-[11.7rem] mt-[13rem]"><img width='40px' src={Pendant} alt="" /></div>
            </div>
            <div className="flex w-10/12 justify-around py-6">
                <div style={{ backgroundColor: IconBorder === 0 ? Bg[0] : '#007fff' }} className={`rounded-full cursor-pointer w-14 h-14 transition-all duration-300 bg-secondary-200 ${IconBorder === 0 ? Border : ''} `} onClick={() => IconStates(0)}></div>
                <div style={{ backgroundColor: IconBorder === 1 ? Bg[1] : '#FF2D2D' }} className={`rounded-full cursor-pointer w-14 h-14 transition-all duration-300 bg-[#FF2D2D] ${IconBorder === 1 ? Border : ''} `} onClick={() => IconStates(1)}></div>
                <div style={{ backgroundColor: IconBorder === 2 ? Bg[2] : '#37FF2D' }} className={`rounded-full cursor-pointer w-14 h-14 transition-all duration-300 bg-[#37FF2D] ${IconBorder === 2 ? Border : ''} `} onClick={() => IconStates(2)}></div>
                <div style={{ backgroundColor: IconBorder === 3 ? Bg[3] : '#7C20BE' }} className={`rounded-full cursor-pointer w-14 h-14 transition-all duration-300 bg-primary-200 ${IconBorder === 3 ? Border : ''} `} onClick={() => IconStates(3)}></div>
