function StoreCards({ children, color, color2, color3 }) {
  return (
    ...
    >
      ...
      <button
        className={`mt-2 w-full rounded-[6px] md:mt-4 md:rounded-md lg:mt-6 ${color3} text-[20px] font-medium text-white transition-all duration-500 hover:bg-white hover:text-black lg:p-1 lg:text-[32px] dark:bg-yellow dark:text-[#351D09]`}
      >
