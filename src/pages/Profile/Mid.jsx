  ...
  return (
    <section className="m-auto mt-20 flex w-[93%] flex-wrap justify-between xl:flex-nowrap 2xl:w-11/12">
      <div className="w-full xl:w-fit">
        <div className="flex w-[200px] justify-center rounded-t-md bg-[rgba(124,32,190,0.50);] font-medium text-[#471650] text-[32px] xl:text-[40px] dark:bg-[#1e1e1e] dark:text-white">
          Missões
        </div>
      ...
      <div className="group w-full xl:ml-5 xl:w-fit">
        <div className="mt-20 flex w-[240px] justify-center rounded-t-md bg-[rgba(124,32,190,0.50);] font-medium text-[#471650] transition-colors duration-500 group-hover:bg-primary-200 group-hover:text-white text-[32px] xl:mt-0 xl:text-[40px] dark:bg-[#1e1e1e] dark:text-white dark:group-hover:bg-[#282828]">
          Conquistas
        </div>
