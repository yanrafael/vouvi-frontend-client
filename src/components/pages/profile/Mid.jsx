...
function Mid() {
    return (
        <section className="w-11/12 m-auto mt-20 flex justify-between">
            <div>
                <div className="bg-[#1e1e1e] flex justify-center w-[200px] text-[40px] text-white rounded-t-md font-medium">Missões</div>
                <div className="bg-[#1e1e1e] rounded-[0px_24px_24px] p-7 flex flex-col">
            ...
            <div className="ml-5">
                <div className="bg-[#1e1e1e] flex justify-center w-[240px] text-[40px] text-white rounded-t-md font-medium">Conquistas</div>
                <div className="bg-[#1e1e1e] rounded-[0px_24px_24px] p-7 flex flex-col h-[92%]">
