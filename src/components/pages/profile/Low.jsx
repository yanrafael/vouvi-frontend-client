    ...
    return (
        <section className="w-11/12 m-auto mt-20 dark:text-white text-[40px] font-medium">
            <div className="bg-[rgba(124,32,190,0.50);] dark:bg-[#1e1e1e] rounded-md p-5 flex flex-col">
                <div className='flex justify-between text-[#471650]'>
                    <h1>Amigos: {friends}</h1>
                    <div className='flex text-[32px] px-2 items-center border-4 rounded-xl border-[#471650] dark:border-white'>
                ...
                <div className='flex justify-end mx-5 mt-3 items-center text-[#471650] dark:text-white'>
