        ...
        <header className="flex items-center justify-around w-11/12 m-auto py-10">
            ...
            <nav className="flex">
                ...
                <div onClick={() => IconStates(0)}>
                    <Navigation width={`w-[224px] group ${textColor === 0 ? UseTextColor : 'text-secondary-200'} ${useOutline === 0 ? Outline : ''}`} fill={` ${fillComponent === 0 ? Fill : ''}`} icon={Learn} title={"Aprender"} />
                </div>

                <div onClick={() => IconStates(1)}>
                    <Navigation width={`w-[204px] group ${textColor === 1 ? UseTextColor : 'text-secondary-200'} ${useOutline === 1 ? Outline : ''} `} fill={` ${fillComponent === 1 ? Fill : ''}`} icon={Planning} title={"Planejar"} />
                </div>

                <div onClick={() => IconStates(2)}>
                    <Navigation width={`w-[204px] group ${textColor === 2 ? UseTextColor : 'text-secondary-200'} ${useOutline === 2 ? Outline : ''} `} fill={` ${fillComponent === 2 ? Fill : ''}`} icon={Ranking} title={"Ranking"} />
                </div>

                <div onClick={() => IconStates(3)}>
                    <Navigation width={`w-[145px] group ${textColor === 3 ? UseTextColor : 'text-secondary-200'} ${useOutline === 3 ? Outline : ''} `} fill={` ${fillComponent === 3 ? Fill : ''}`} icon={Store} title={"Loja"} />
                </div>
