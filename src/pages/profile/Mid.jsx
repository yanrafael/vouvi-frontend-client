...
function Mid({ openModal }) {
  return (
    <section className="m-auto mt-20 flex flex-wrap xl:flex-nowrap w-[93%] 2xl:w-11/12 justify-between">
      <div className="w-full xl:w-fit">
        <div className="flex w-[200px] justify-center rounded-t-md bg-[rgba(124,32,190,0.50);] lg:text-[32px] xl:text-[40px] font-medium text-[#471650] dark:bg-[#1e1e1e] dark:text-white" >
          Missões
        </div>
      ...
      <div className="group xl:ml-5 w-full xl:w-fit">
        ...
        <div className="flex xl:h-[92%] flex-col rounded-[0px_24px_24px] bg-[rgba(124,32,190,0.50);] p-7 transition-colors duration-500 group-hover:bg-primary-200 dark:bg-[#1e1e1e] dark:group-hover:bg-[#282828]">
          <Insigne
            icon={VouviLover}
            title={"Vouvi lover"}
            text={"Seja Premium"}
