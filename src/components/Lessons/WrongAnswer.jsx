import energyWrong from "../../assets/images/energy-wrong.svg";
...
function FinCheer({ title, text, next, to }) {
  return (
    ...
    >
      <div className="flex h-fit w-fit gap-10 rounded-lg border-8 border-red bg-secondary-300 p-10">
        <img src={energyWrong} alt="fin piscando" />

        <div className="flex flex-col gap-14">
          <h1 className="text-lg font-bold text-red">{title}</h1>
