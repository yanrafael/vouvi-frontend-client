        ...
        <>
            ...
            <section className='bg-[#0029524D] flex flex-col rounded-[72px] w-11/12 m-auto p-20 mt-52 leading-[1]'>
                <div className='flex m-auto'>
                    <img src={Target} alt="" />
                    <div className='bg-[#0029524D] flex flex-col w-[650px] relative p-8 h-fit rounded-md text-white mx-20'>
                ...
                <div className='flex justify-between mt-20'>
                    ...
                    <div className='bg-[#0029524D] flex flex-col w-[690px] relative p-8 h-fit rounded-md text-white bottom-40'>
