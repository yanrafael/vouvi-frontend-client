...
const Card = (props) =>{
    return(
      <div className="flex justify-between items-center lg:text-md bg-card p-2 mb-2 rounded-[20px]  text-primary-200  bg-primary-200 dark:bg-[#3D3D3D] md:h-14 md:w-[370px] lg:w-[700px] w-[300px] h-10 ml-7 md:ml-10 lg:ml-20 -mt-1"> 
