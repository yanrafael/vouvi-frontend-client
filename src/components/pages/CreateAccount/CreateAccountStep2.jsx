...
function CreateAccountStep2({ setStep, day, setDay, month, setMonth, year, setYear, age, setAge, gender, setGender, pronoum, setPronoum }) {
    return (
        <>
            ...
            <div className="flex flex-col gap-5 justify-around">
                <div className="grid grid-cols-3 gap-4">
                    <span className="grid">
                        ...
                        <Input type="number" min={1} max={31} value={day} onChange={(e) => setDay(e.target.value)} name="day-of-birth" id="day-of-birth" isRequired />
                    </span>

                    <span className="grid">
                        <Label htmlFor="month-of-birth">Mês:</Label>
                        <Input type="number" min={1} max={12} value={month} onChange={(e) => setMonth(e.target.value)} name="month-of-birth" id="month-of-birth" isRequired />
                    </span>

                    <span className="grid">
                        <Label htmlFor="year-of-birth">Ano:</Label>
                        <Input type="number" min={1900} max={new Date().getFullYear()} value={year} onChange={(e) => setYear(e.target.value)} name="year-of-birth" id="year-of-birth" isRequired />
                    </span>
                </div>

                <span className="flex flex-col">
                    <Label htmlFor="age">Sua Idade:</Label>
                    <Input type="number" min={14} max={110} value={age} name="age" id="age" isRequired isReadOnly />
                </span>
